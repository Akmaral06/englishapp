...
<h2 style="text-align:center; margin-bottom:30px;">{{ __('app.charts_title') }}</h2>

<div style="display:flex; flex-wrap:wrap; gap:25px; justify-content:center;">

    <div class="card" style="flex:1; min-width:280px; max-width:450px;">
        <h3 style="text-align:center; color:#1565c0; margin-bottom:15px;">📊 {{ __('app.charts_bar') }}</h3>
        <canvas id="barChart" style="max-height:250px;"></canvas>
    </div>

    <div class="card" style="flex:1; min-width:280px; max-width:450px;">
        <h3 style="text-align:center; color:#1565c0; margin-bottom:15px;">🥧 {{ __('app.charts_pie') }}</h3>
        <canvas id="pieChart" style="max-height:250px;"></canvas>
    </div>

    <div class="card" style="flex:1; min-width:280px; max-width:450px;">
        <h3 style="text-align:center; color:#1565c0; margin-bottom:15px;">🎯 {{ __('app.charts_polar') }}</h3>
        <canvas id="polarChart" style="max-height:250px;"></canvas>
    </div>

    <div class="card" style="flex:1; min-width:280px; max-width:450px;">
        <h3 style="text-align:center; color:#1565c0; margin-bottom:15px;">📈 {{ __('app.charts_line') }}</h3>
