                ...
                <td style="padding:12px; text-align:right;">
                    ...
                    <?php if (\Illuminate\Support\Facades\Blade::check('role', 'reviewer')): ?>
                        <?php if($lesson->status == 'pending'): ?>
                            <a href="/lessons/<?php echo e($lesson->id); ?>/approve" class="btn" style="padding:5px 10px; font-size:11px; background:#28a745;">Approve</a>
                            <a href="/lessons/<?php echo e($lesson->id); ?>/reject" class="btn" style="padding:5px 10px; font-size:11px; background:#ffc107; color:black;">Reject</a>
                        <?php endif; ?>
                    <?php endif; ?>

                    
                    <?php if(Auth::id() == $lesson->user_id): ?>
                        <a href="/lessons/<?php echo e($lesson->id); ?>/edit" class="btn" style="padding:5px 10px; font-size:11px; background:#007bff;">Edit</a>
                    <?php endif; ?>
                    ...
                    <?php if(Auth::id() == $lesson->user_id || Auth::user()->hasRole('admin')): ?>
                        <form action="/lessons/<?php echo e($lesson->id); ?>" method="POST" style="display:inline;" onsubmit="return confirm('Delete this lesson?')">
                            ...
                            <button type="submit" class="btn" style="padding:5px 10px; font-size:11px; background:#dc3545;">Delete</button>
                        </form>
                    <?php endif; ?>
                </td>
            </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xam\htdocs\example-app\resources\views/lessons/index.blade.php ENDPATH**/ ?>