...
<form action="/lessons/store" method="POST" enctype="multipart/form-data">
    ...
    <div class="card">
        ...
        <input type="text" name="title" value="<?php echo e(old('title')); ?>" placeholder="e.g. How to Use Articles: A, An, The" required
        ...
        <input type="text" name="subtitle" value="<?php echo e(old('subtitle')); ?>" placeholder="e.g. Learn when to use definite and indefinite articles"
               style="width:100%; padding:12px; border:1px solid #ddd; border-radius:8px; box-sizing:border-box; font-size:1em;">
    </div>
    ...
    <div class="card">
        ...
        <div style="display:flex; gap:12px; flex-wrap:wrap;">
            ...
            <label style="flex:1; min-width:140px; cursor:pointer;">
                <input type="radio" name="type" value="<?php echo e($t['value']); ?>" <?php echo e(old('type','general') == $t['value'] ? 'checked' : ''); ?>

                       style="display:none;" onchange="updateTheme('<?php echo e($t['color']); ?>','<?php echo e($t['value']); ?>')">
                <div class="type-card" id="tc-<?php echo e($t['value']); ?>"
                     style="border:2px solid <?php echo e(old('type','general') == $t['value'] ? $t['color'] : '#ddd'); ?>;
                            background:<?php echo e(old('type','general') == $t['value'] ? $t['bg'] : 'white'); ?>;
                            border-radius:10px; padding:15px; text-align:center; transition:all 0.2s;">
                    <div style="font-size:1.8em;"><?php echo e(explode(' ',$t['label'])[0]); ?></div>
                    <div style="font-weight:600; color:<?php echo e($t['color']); ?>; margin-top:5px;"><?php echo e(implode(' ', array_slice(explode(' ',$t['label']),1))); ?></div>
                    <div style="font-size:0.8em; color:#777; margin-top:3px;"><?php echo e($t['desc']); ?></div>
                </div>
            </label>
    ...
    <div class="card">
        ...
        <div style="display:flex; gap:20px; flex-wrap:wrap; align-items:flex-end;">
            <div style="flex:1; min-width:200px;">
                ...
                <input type="text" name="icon" id="iconInput" value="<?php echo e(old('icon','📝')); ?>" placeholder="📝"
            ...
            <div style="flex:1; min-width:200px;">
                ...
                <div style="display:flex; gap:8px; flex-wrap:wrap;">
                    <?php $__currentLoopData = ['#1565c0'=>'Blue','#4caf50'=>'Green','#ff9800'=>'Orange','#9c27b0'=>'Purple','#dc3545'=>'Red','#6c757d'=>'Grey']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color=>$name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <label style="cursor:pointer;" title="<?php echo e($name); ?>">
                        <input type="radio" name="color_theme" value="<?php echo e($color); ?>" <?php echo e(old('color_theme','#1565c0') == $color ? 'checked' : ''); ?>

                               style="display:none;">
                        <div style="width:36px; height:36px; background:<?php echo e($color); ?>; border-radius:50%; border:3px solid <?php echo e(old('color_theme','#1565c0') == $color ? '#333' : 'transparent'); ?>;
                                    transition:border 0.2s;" title="<?php echo e($name); ?>"></div>
                    </label>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
    ...
    <div class="card">
        ...
        <textarea name="content" rows="6" required placeholder="e.g. Articles are small words placed before nouns. In English there are two types: definite (the) and indefinite (a, an). We use 'a' before consonant sounds and 'an' before vowel sounds..."
               style="width:100%; padding:14px; border:1px solid #ddd; border-radius:8px; box-sizing:border-box;
                      font-family:'Segoe UI',sans-serif; font-size:0.95em; resize:vertical; line-height:1.6;"><?php echo e(old('content')); ?></textarea>
    </div>
...
Do NOT use an article with most country names (France, Russia)"
               style="width:100%; padding:14px; border:1px solid #ddd; border-radius:8px; box-sizing:border-box;
                      font-family:'Segoe UI',sans-serif; font-size:0.95em; resize:vertical; line-height:1.8;"><?php echo e(old('key_points')); ?></textarea>
...
The Eiffel Tower is in Paris. — specific famous place"
               style="width:100%; padding:14px; border:1px solid #ddd; border-radius:8px; box-sizing:border-box;
                      font-family:'Segoe UI',sans-serif; font-size:0.95em; resize:vertical; line-height:1.8;"><?php echo e(old('examples')); ?></textarea>
    ...
    <div class="card" style="border-left:4px solid #4caf50;">
        ...
        <textarea name="practice_tip" rows="3" placeholder="e.g. Try reading a short English text and circle all the articles you find. Ask yourself: why did the author use 'a', 'an', or 'the' here?"
               style="width:100%; padding:14px; border:1px solid #ddd; border-radius:8px; box-sizing:border-box;
                      font-family:'Segoe UI',sans-serif; font-size:0.95em; resize:vertical; line-height:1.6;"><?php echo e(old('practice_tip')); ?></textarea>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xam\htdocs\englishapp-fixed (1)\englishapp\resources\views/lessons/create.blade.php ENDPATH**/ ?>