...
<form action="/lessons/<?php echo e($lesson->id); ?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="card">
        ...
        <input type="text" name="subtitle" value="<?php echo e(old('subtitle', $lesson->subtitle)); ?>"
               style="width:100%; padding:12px; border:1px solid #ddd; border-radius:8px; box-sizing:border-box; font-size:1em;">
    </div>
    ...
    <div class="card">
        ...
        <div style="display:flex; gap:12px; flex-wrap:wrap;">
            ...
            <label style="flex:1; min-width:120px; cursor:pointer;">
                <input type="radio" name="type" value="<?php echo e($t['value']); ?>" <?php echo e($cur == $t['value'] ? 'checked' : ''); ?>
                ...
                <div class="type-card" id="tc-<?php echo e($t['value']); ?>"
                     style="border:2px solid <?php echo e($cur == $t['value'] ? $t['color'] : '#ddd'); ?>;
                            background:<?php echo e($cur == $t['value'] ? $t['bg'] : 'white'); ?>;
                            border-radius:10px; padding:12px; text-align:center; transition:all 0.2s; font-size:0.9em;">
                    <div style="font-size:1.5em;"><?php echo e(explode(' ',$t['label'])[0]); ?></div>
                    <div style="font-weight:600; color:<?php echo e($t['color']); ?>; margin-top:3px;"><?php echo e(implode(' ', array_slice(explode(' ',$t['label']),1))); ?></div>
                </div>
            </label>
    ...
    <div class="card">
        ...
        <div style="display:flex; gap:20px; flex-wrap:wrap; align-items:flex-end;">
            <div style="flex:1; min-width:200px;">
                ...
                <input type="text" name="icon" value="<?php echo e(old('icon', $lesson->icon ?? '📝')); ?>"
            ...
            <div style="flex:1; min-width:200px;">
                ...
                <div style="display:flex; gap:8px; flex-wrap:wrap;">
                    ...
                    <label style="cursor:pointer;" title="<?php echo e($name); ?>">
                        <input type="radio" name="color_theme" value="<?php echo e($color); ?>"
                               <?php echo e(old('color_theme', $lesson->color_theme ?? '#1565c0') == $color ? 'checked' : ''); ?>

                               style="display:none;">
                        <div style="width:36px; height:36px; background:<?php echo e($color); ?>; border-radius:50%;
                                    border:3px solid <?php echo e(old('color_theme', $lesson->color_theme ?? '#1565c0') == $color ? '#333' : 'transparent'); ?>;
    ...
    <div class="card">
        ...
        <textarea name="content" rows="6" required
               style="width:100%; padding:14px; border:1px solid #ddd; border-radius:8px; box-sizing:border-box;
                      font-family:'Segoe UI',sans-serif; font-size:0.95em; resize:vertical; line-height:1.6;"><?php echo e(old('content', $lesson->content)); ?></textarea>
    </div>
    ...
    <div class="card" style="border-left:4px solid #1565c0;">
        ...
        <textarea name="key_points" rows="6"
               style="width:100%; padding:14px; border:1px solid #ddd; border-radius:8px; box-sizing:border-box;
                      font-family:'Segoe UI',sans-serif; font-size:0.95em; resize:vertical; line-height:1.8;"><?php echo e(old('key_points', $lesson->key_points)); ?></textarea>
    ...
    <div class="card" style="border-left:4px solid #ff9800;">
        ...
        <textarea name="examples" rows="6"
               style="width:100%; padding:14px; border:1px solid #ddd; border-radius:8px; box-sizing:border-box;
                      font-family:'Segoe UI',sans-serif; font-size:0.95em; resize:vertical; line-height:1.8;"><?php echo e(old('examples', $lesson->examples)); ?></textarea>
    ...
    <div class="card" style="border-left:4px solid #4caf50;">
        ...
        <textarea name="practice_tip" rows="3"
               style="width:100%; padding:14px; border:1px solid #ddd; border-radius:8px; box-sizing:border-box;
                      font-family:'Segoe UI',sans-serif; font-size:0.95em; resize:vertical; line-height:1.6;"><?php echo e(old('practice_tip', $lesson->practice_tip)); ?></textarea>
    </div>
    ...
    <div class="card">
        ...
        <?php if($lesson->file_path): ?>
            <div style="margin-bottom:12px; padding:12px; background:#e8f5e9; border-radius:8px;">
                <span style="color:#2e7d32;">📎 Current file: <strong><?php echo e(basename($lesson->file_path)); ?></strong></span>
            </div>
        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xam\htdocs\englishapp-fixed (1)\englishapp\resources\views/lessons/edit.blade.php ENDPATH**/ ?>